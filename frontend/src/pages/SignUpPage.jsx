...
export const SignUpPage = () => {
  ...
  const handleSubmit = (e) => {
    ...
    if (successs === true) signup(formData);
  }
  ...
  return (
    <div className="min-h-screen grid lg:grid-cols-2 overflow-hidden">
      ...
      <div className="flex flex-col justify-center items-center p-6 sm:p-12 sm:pt-[14%] h-screen">
            ...
            <form onSubmit={handleSubmit} className="space-y-6 mt-5">
              <div className="flex flex-col items-start space-y-1">
                ...
                <div className="relative w-full">
                  ...
                  <input type="text" placeholder="John Doe" className="w-full pl-10 border border-neutral-500/40 py-1.5 rounded-md" value={formData.fullName} onChange={e => setFormData({ ...formData, fullName: e.target.value })} />
              </div>
            </div>
            <div className="flex flex-col items-start space-y-1">
              <label>
        ...
        <button type="submit" className="px-2 py-2 w-full bg-orange-500 hover:bg-orange-600/80 rounded-md flex items-center justify-center gap-1.5" disabled={isSigningUp}>
          {
          isSigningUp ? (<>
